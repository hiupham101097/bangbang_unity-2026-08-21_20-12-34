...
namespace BangBang.Core.Data
{
    public static class CardCatalogDatabase
    {
        ...
        private static readonly Dictionary<string, CharacterInfo> Characters = new Dictionary<string, CharacterInfo>();
        ...
        public static string GetTypeOf(string cardId)
        {
            ...
            if (parts.Length > 2 && parts[0] == "gun" && parts[1] == "range")
            {
        ...
        public static Sprite LoadSprite(string resourcePath)
        {
            ...
            // Try load directly as Sprite
            var sprite = Resources.Load<Sprite>(resourcePath);
            if (sprite == null)
            {
                // Try load Texture2D and create Sprite
